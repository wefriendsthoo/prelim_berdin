function RANDOM(){
    ...
    if(random1=== 1){
        P1.src = "./Image/Rock.png";
    }else if(random1===2){
        P1.src="./Image/Paper.png";
    }else if(random1===3){
        P1.src="./Image/Scissor.png";
    }
    ...
    if(random2=== 1){
        P2.src="./Image/Rock.png";
    }else if(random2===2){
        P2.src="./Image/Paper.png";
    }else if(random2===3){
        P2.src="./Image/Scissor.png";
    }
    ...
    P1P.textContent= '';
    P2P.textContent= '';
    P1.src="./Image/dice.jpg";
    P2.src="./Image/dice.jpg";
    }